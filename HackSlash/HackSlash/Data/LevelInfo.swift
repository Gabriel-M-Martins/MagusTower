...
enum Levels: CaseIterable {
    ...
    func getInfo() -> LevelInfo {
        ...
        case .Level8:
            return LevelInfo(background: "MainScene", enemiesQtd: 5, mapFile: "map7", spawnRate: 3)
        case .Level9:
            return LevelInfo(background: "MainScene", enemiesQtd: 7, mapFile: "map3", spawnRate: 3)
        case .Level10:
            return LevelInfo(background: "MainScene", enemiesQtd: 10, mapFile: "map6", spawnRate: 3)
        }
    }
