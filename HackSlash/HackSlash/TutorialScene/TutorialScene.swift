...
//        player.setEffect(effect: "DirtParticle")
    ...
    func setupSpider(spriteName: String, idSpider: Int) -> EnemySpider{
        let spider = EnemySpider(sprite: spriteName, attributes: AttributesInfo(health: 30, defense: 20, weakness: [], resistence: [], velocity: VelocityInfo(xSpeed: 50, ySpeed: 10, maxXSpeed: 200, maxYSpeed: 5000), attackRange: frame.width * 0.3, maxHealth: 50), player: player, idSpider: idSpider)
        return spider
    }
}
